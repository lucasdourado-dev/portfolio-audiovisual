<?php
    if (!isset($activePage)) {
        ...
        $currentUri = isset($basePath) ? str_replace($basePath, '', $currentUri) : $currentUri;
    ...
    <nav class="menu">
        ...
        <ul>
            ...
            <li class="menu-itens <?= (isset($activePage) && $activePage == 'video') ? 'active-page' : '' ?>">
                <a href="<?= $basePath; ?>/pages/video.php">VIDEO</a></li>
            <li class="menu-itens <?= (isset($activePage) && $activePage == 'design') ? 'active-page' : '' ?>">
                <a href="<?= $basePath; ?>/pages/design.php">DESIGN</a></li>
        </ul>
        <ul>
            <li class="menu-itens <?= (isset($activePage) && $activePage == 'sobre') ? 'active-page' : '' ?>">
                <a href="<?= $basePath; ?>/pages/sobre.php">SOBRE</a></li>
            <li class="menu-itens <?= (isset($activePage) && $activePage == 'contato') ? 'active-page' : '' ?>">
                <a href="<?= $basePath; ?>/pages/contato.php">CONTATO</a></li>
        </ul>
    </nav>
</header>